...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/Search */ \"./src/js/models/Search.js\");\n/* harmony import */ var _views_searchView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/searchView */ \"./src/js/views/searchView.js\");\n/* harmony import */ var _views_singleFlatView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/singleFlatView */ \"./src/js/views/singleFlatView.js\");\n/* harmony import */ var _views_sliderView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/sliderView */ \"./src/js/views/sliderView.js\");\n/* harmony import */ var _views_base__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n/* harmony import */ var _components_navigation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/navigation */ \"./src/js/components/navigation.js\");\n/* harmony import */ var _components_navigation__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_navigation__WEBPACK_IMPORTED_MODULE_5__);\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\n\n // components \n\n\nvar state = {\n  /** \n   * activeInvestment: {Investment instance of recently fetched data}\n   * filters: <---- filters object (data colleted from search form inputs)\n   * flats: []  <--- Array of all flats from fatched DATA\n   * filteredFlats: [] <--- Array of flats after executing filters\n   */\n};\nwindow.s = state; // Filtering flats controller\n\nvar controlFiltering =\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee() {\n    var newFilters;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            newFilters = _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"getFilters\"](); // Data is not fetched yet OR user changed Investment\n\n            if (!(!state.activeInvestment || newFilters.investment !== state.activeInvestment.filters.investment)) {\n              _context.next = 21;\n              break;\n            }\n\n            console.log('poszło');\n            _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"clearInputs\"]();\n            _context.prev = 4;\n            state.activeInvestment = new _models_Search__WEBPACK_IMPORTED_MODULE_0__[\"default\"](newFilters);\n            Object(_views_base__WEBPACK_IMPORTED_MODULE_4__[\"renderLoader\"])();\n            _context.next = 9;\n            return state.activeInvestment.getFlats(newFilters.investment);\n\n          case 9:\n            state.activeInvestment.calcPricePerMeter();\n            state.activeInvestment.filterFlats(state.activeInvestment.filters);\n            Object(_views_base__WEBPACK_IMPORTED_MODULE_4__[\"removeLoader\"])();\n            _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"clearFlats\"]();\n            _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderFlats\"](state.activeInvestment.flats);\n            _context.next = 19;\n            break;\n\n          case 16:\n            _context.prev = 16;\n            _context.t0 = _context[\"catch\"](4);\n            alert(_context.t0);\n\n          case 19:\n            _context.next = 22;\n            break;\n\n          case 21:\n            if (state.activeInvestment.compareFilters(newFilters)) {\n              console.log('inne filtry');\n              state.activeInvestment.filters = newFilters;\n              state.activeInvestment.filterFlats(state.activeInvestment.filters);\n              _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"clearFlats\"]();\n              _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderFlats\"](state.activeInvestment.filteredFlats);\n            } else {\n              console.log('nic sie nie zmienilo');\n            }\n\n          case 22:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, this, [[4, 16]]);\n  }));\n\n  return function controlFiltering() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\ndocument.querySelector('.search-form').addEventListener('submit', function (e) {\n  e.preventDefault();\n  controlFiltering();\n}); // Sorting flats controller\n\nvar controlSorting = function controlSorting(target) {\n  if (state.activeInvestment && state.activeInvestment.filteredFlats) {\n    var sortNavItem = target.closest('.table-nav-item'); // console.log(target.closest('.table-nav-item').dataset);\n    // state.activeInvestment.setSortMode(sortNavItem.getAttribute('data-sort'));\n\n    var sortDirection = _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"handleSortingClasses\"](sortNavItem);\n    state.activeInvestment.sortFlats(sortNavItem.dataset.sort, sortDirection);\n    _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"clearFlats\"]();\n    _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderFlats\"](state.activeInvestment.filteredFlats);\n  }\n};\n\ndocument.querySelector('.table-nav').addEventListener('click', function (e) {\n  if (e.target.matches('.table-nav-item, .table-nav-item *')) {\n    controlSorting(e.target);\n  }\n}); // Single flat preview controller\n\nvar controlFlatPreview = function controlFlatPreview(target) {\n  var ID = target.parentNode.parentNode.parentNode.id;\n  var flatIndex = state.activeInvestment.flats.findIndex(function (el) {\n    return el.flatID === ID;\n  });\n  console.log(ID);\n  _views_singleFlatView__WEBPACK_IMPORTED_MODULE_2__[\"showModal\"]();\n  _views_singleFlatView__WEBPACK_IMPORTED_MODULE_2__[\"renderDetails\"](_objectSpread({}, state.activeInvestment.flats[flatIndex]));\n};\n\ndocument.querySelector('.flats').addEventListener('click', function (e) {\n  if (e.target.matches('.flat-preview .fa-search-plus')) {\n    e.preventDefault();\n    controlFlatPreview(e.target);\n  } else if (e.target.matches('.modal .close-btn, .modal .close-btn *')) {\n    _views_singleFlatView__WEBPACK_IMPORTED_MODULE_2__[\"closeModal\"]();\n  }\n}); //  SLIDER controller\n// window.slider = slider;\n\nwindow.addEventListener('load', function () {\n  _views_sliderView__WEBPACK_IMPORTED_MODULE_3__[\"startSlider\"]({\n    duration: 4000,\n    fadeMode: true\n  });\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
/*!******************************!*\
  !*** ./src/js/views/base.js ***!
  \******************************/
/*! exports provided: renderLoader, removeLoader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!************************************!*\
  !*** ./src/js/views/searchView.js ***!
  \************************************/
/*! exports provided: getFilters, clearInputs, renderFlats, clearFlats, handleSortingClasses */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getFilters\", function() { return getFilters; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearInputs\", function() { return clearInputs; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderFlats\", function() { return renderFlats; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearFlats\", function() { return clearFlats; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handleSortingClasses\", function() { return handleSortingClasses; });\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nvar getFilters = function getFilters() {\n  var fields = [].slice.call(document.querySelectorAll('.search-form select, .search-form .input'));\n  var filters = {};\n\n  for (var i = 0; i < fields.length; i++) {\n    filters[fields[i].id] = fields[i].tagName === 'SELECT' ? fields[i].value : parseFloat(fields[i].value).toFixed(2);\n  }\n\n  return filters;\n};\nvar clearInputs = function clearInputs() {\n  var fields = [].slice.call(document.querySelectorAll('.search-form .input'));\n  fields.forEach(function (field) {\n    return field.value = '';\n  });\n  console.log('cleared fields');\n};\n\nvar renderFlat = function renderFlat(_ref) {\n  var flatID = _ref.flatID,\n      price = _ref.price,\n      floor = _ref.floor,\n      rooms = _ref.rooms,\n      area = _ref.area,\n      status = _ref.status,\n      planIMG = _ref.planIMG,\n      pricePerMeter = _ref.pricePerMeter;\n  var html = \"\\n          <tr class=\\\"table-row\\\" id=\\\"\".concat(flatID, \"\\\">\\n            <th class=\\\"flat-id\\\">\").concat(flatID, \"</th>\\n            <td class=\\\"flat-floor\\\">\").concat(floor, \"</td>\\n            <td class=\\\"flat-rooms\\\">\").concat(rooms, \"</td>\\n            <td class=\\\"flat-area\\\">\").concat(area, \" m2</td>\\n            <td class=\\\"flat-price\\\">\").concat(price, \" $</td>\\n            <td class=\\\"flat-price-m2\\\">\").concat(pricePerMeter, \" $</td>\\n            <td class=\\\"flat-status\\\">\").concat(status, \"</td>\\n            <td class=\\\"flat-preview\\\"><a href=\\\"\").concat(planIMG, \"\\\"><i class=\\\"fas fa-search-plus\\\"></i></a></td>\\n          </tr> \\n    \");\n  document.querySelector('.table-body').insertAdjacentHTML('beforeend', html);\n};\n\nvar renderFlats = function renderFlats(flats) {\n  var tableBody = document.createElement('TBODY');\n  tableBody.className = 'table-body';\n  document.querySelector('.table').appendChild(tableBody);\n  flats.forEach(function (item) {\n    return renderFlat(_objectSpread({}, item));\n  });\n};\nvar clearFlats = function clearFlats() {\n  if (document.querySelector('.table-body')) {\n    document.querySelector('.table').removeChild(document.querySelector('.table-body'));\n  }\n};\nvar handleSortingClasses = function handleSortingClasses(el) {\n  var sortDirection;\n\n  if (!el.classList.contains('ascending')) {\n    el.classList.remove('descending');\n    el.classList.add('ascending');\n    sortDirection = 'ascending';\n  } else {\n    el.classList.remove('ascending');\n    el.classList.add('descending');\n    sortDirection = 'descending';\n  } // console.log(sortDirection);\n\n\n  return sortDirection; // RESET ascending / descending classes\n  // const tableNavItems = [].slice.call(document.querySelectorAll(`.table-nav-item:not(.${el.className.replace(' ', '.')})`))\n  // tableNavItems.forEach(el => el.className = 'table-nav-item');\n};\n\n//# sourceURL=webpack:///./src/js/views/searchView.js?");

/***/ }),

/***/ "./src/js/views/singleFlatView.js":
/*!****************************************!*\
  !*** ./src/js/views/singleFlatView.js ***!
  \****************************************/
/*! exports provided: showModal, closeModal, renderDetails */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"showModal\", function() { return showModal; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"closeModal\", function() { return closeModal; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderDetails\", function() { return renderDetails; });\nvar showModal = function showModal() {\n  document.querySelector('.modal').classList.add('is-active');\n};\n\nvar clearModalContent = function clearModalContent() {\n  document.querySelector('.modal-card-body').innerHTML = '';\n};\n\nvar closeModal = function closeModal() {\n  document.querySelector('.modal').classList.remove('is-active');\n  clearModalContent();\n};\nvar renderDetails = function renderDetails(_ref) {\n  var flatID = _ref.flatID,\n      price = _ref.price,\n      floor = _ref.floor,\n      rooms = _ref.rooms,\n      area = _ref.area,\n      status = _ref.status,\n      planIMG = _ref.planIMG,\n      pricePerMeter = _ref.pricePerMeter;\n  var html = \"\\n    <p>\".concat(flatID, \"</p>\\n    <p>\").concat(price, \"</p>\\n    <p>\").concat(floor, \"</p>\\n    <p>\").concat(rooms, \"</p>\\n    <p>\").concat(area, \"</p>\\n    <p>\").concat(status, \"</p>\\n    <p>\").concat(pricePerMeter, \"</p>\\n    <img src=\\\"\").concat(planIMG, \"\\\">\\n    \");\n  document.querySelector('.modal-card-body').insertAdjacentHTML('afterbegin', html);\n};\n\n//# sourceURL=webpack:///./src/js/views/singleFlatView.js?");
